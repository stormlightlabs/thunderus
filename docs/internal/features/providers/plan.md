...
Show subscription, credit, or rate-limit windows only when a supported account
API exposes them. Do not scrape or infer zero from missing data. `/usage` owns
refresh and detail; other surfaces may show only compact redacted snapshots.
