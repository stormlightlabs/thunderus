...
- Related ideas: visible context from Pi, scoped project layout from monorepos,
  read-only traversal tools from [fs-traversal](/docs/notebook/fs-traversal/), release
  gates from [release](/docs/notebook/release/).
- Related sources: [pi](/docs/notebook/pi/), [herdr](/docs/notebook/herdr/),
  [ui-patterns](/docs/notebook/ui-patterns/), [providers/umans](/docs/notebook/providers/umans/).
