...
- Related ideas: agent scaffolding, repository-local memory, progressive
  ...
  context.
- Related sources:
  [codex-prompting-guide](/docs/notebook/codex-prompting-guide/),
  [codex-prompts](/docs/notebook/codex-prompts/), [agents-md](/docs/notebook/agents-md/),
  [skills](/docs/notebook/skills/), [sessions](/docs/notebook/sessions/).
