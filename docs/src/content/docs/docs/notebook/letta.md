...
- Related ideas: durable session logs, context compaction, retrieval-augmented
  ...
  as context assembly.
- Related sources: [sessions](/docs/notebook/sessions/), [skills](/docs/notebook/skills/),
  [agents-md](/docs/notebook/agents-md/), [prompt-renderer-research](/docs/notebook/prompt-renderer-research/).
