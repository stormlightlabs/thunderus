...
- Related ideas: [prompts](/docs/notebook/prompts/), [fs-traversal](/docs/notebook/fs-traversal/),
  [sessions](/docs/notebook/sessions/), prompt XML syntax, review prompts, and session
  summaries.
