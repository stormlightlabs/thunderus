...
- Full-screen Ratatui shell with sidebar, transcript, prompt, and footer.
- Clap-based CLI with model, workspace, web-search, tick-rate, alternate-screen,
  and prompt-inspection options.
