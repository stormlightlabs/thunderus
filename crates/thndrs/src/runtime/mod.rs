...
pub(crate) use commands::{
    ...
    run_mcp_catalog_configure, run_mcp_catalog_inspect, run_mcp_catalog_list, run_mcp_catalog_search,
    run_mcp_catalog_show, run_mcp_catalog_update, run_mcp_list, run_mcp_remove, run_mcp_resource, run_mcp_resources,
    run_mcp_revoke, run_mcp_tools, run_mcp_trust, run_session_export, run_session_inspect, run_session_latest,
    run_session_list, run_session_prune, run_session_purge, run_session_rename, run_session_show, run_session_storage,
    run_session_titles,
};
