...
#[derive(Props)]
pub(crate) struct HelpScreenProps {
    pub(crate) initial_help: Option<HelpApp>,
...
#[component]
pub(crate) fn HelpScreen(mut hooks: Hooks, props: &mut HelpScreenProps) -> impl Into<AnyElement<'static>> {
